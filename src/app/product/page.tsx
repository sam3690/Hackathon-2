    ...
    <div className='flex flex-col justify-center items-center'>
        <div className='w-full h-20'>
            ...
            <div className='flex w-full px-20 flex-row gap-2 py-10 justify-start items-center'>
                ...
                <h1 className='text-lg ml-8 text-black font-semibold'>Asgaard Sofa</h1>
            </div>
            {/* Product details */}
                ...
                <div className='flex flex-row gap-10 '>
                    ...
                    <div className='flex flex-col gap-10 p-8'>
                        <div className='flex flex-wrap flex-col h-[80px] w-[76px] rounded-lg bg-[#FFF9E5] items-center justify-center'>
                            <Image src={outDoorSofa} height={100} width={100} alt='outdoor sofa' className='mb-2 mr-1  h-auto w-auto justify-center '/>
                        </div>
                    ...
                    <div className='h-[500px] w-[423px] rounded-lg flex items-center bg-[#FFF9E5]'>
                        <Image src={asgaard} height={1000} width={1000} alt='outdoor sofa' className='my-2  h-auto w-full justify-center '/>
                    </div>
                    <div className='flex flex-col gap-6 px-10 py-3 items-start'>
                        <h1 className='text-5xl font-medium'>Asgaard Sofa</h1>
